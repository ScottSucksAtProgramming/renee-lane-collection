 ...
 * 07-01-2022 | SRK | Contract statistics and documetation updated for beta release.
 */
 ...
 * other contracts. Specifically OpenZeppelin's ERC20, ERC20Burnable,
 * ERC20Capped, and Ownable libraries.
 */
 ...
 *
 * @notice The ReneeCoin Contract inherits OpenZeppelin's ERC20,
 * ERC20Burnable, ERC20Capped and Ownable extenions to ensure compliance to
 * the current standards and provide a strong security basis with code that
 * has been vetted elsewhere.
 */
contract ReneeCoins is ERC20, ERC20Burnable, ERC20Capped, Ownable {
    //* ------------------------ Data Structures -------------------------- //
    /**
     * @notice No data structures created for this contract.
     */
    //* --------------------------- Constructor --------------------------- //
    /**
     * @notice The constructor helps set up the initial state of the smart
     * contract. It is called when the contract is deployed. In the
     * constructor the total number of Renee Coins which can be in circulation
     * at any given time is capped at 2,000,000. This cap is only set during
     * the deployment of this contract and cannot be changed later.
     *
    ...
    //* ----------------------- Public Functions -------------------------- //
    /**
     * @notice Public functions are callable by anyone, external or internal.
     *
     * @notice There are no public functions in this contract.
     */
    ...
    //* ----------------------- Internal Functions ------------------------ //
    /**
     * @notice Internal functions can ONLY be called by this contract itself.
     */

    /**
     * @notice The _mint() function replaces the inherited functions from
